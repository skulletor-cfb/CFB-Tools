...
namespace EditorTest
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void AmericanScheduleZ()
        {
            AmericanSchedule.CreateZ().Verify(14, RecruitingFixup.AmericanId, "American", false);
            var hash = AmericanSchedule.CreateZ().BuildHashSet();
            Assert.IsTrue(hash.All(kvp => kvp.Value.Count == 8));
        }


        [TestMethod]
        public void AmericanScheduleY()
        {
            AmericanSchedule.CreateY().Verify(14, RecruitingFixup.AmericanId, "American", false);
            var hash = AmericanSchedule.CreateY().BuildHashSet();
            Assert.IsTrue(hash.All(kvp => kvp.Value.Count == 8));
        }


        [TestMethod]
        public void AmericanScheduleX()
        {
            AmericanSchedule.CreateX().Verify(14, RecruitingFixup.AmericanId, "American", false);
            var hash = AmericanSchedule.CreateX().BuildHashSet();
            Assert.IsTrue(hash.All(kvp => kvp.Value.Count == 8));
        }


        [TestMethod]
        public void AmericanScheduleW()
        {
            AmericanSchedule.CreateW().Verify(14, RecruitingFixup.AmericanId, "American", false);
            var hash = AmericanSchedule.CreateW().BuildHashSet();
            Assert.IsTrue(hash.All(kvp => kvp.Value.Count == 8));
        }


        [TestMethod]
        public void AmericanScheduleR()
        {
            AmericanSchedule.CreateR().Verify(14, RecruitingFixup.AmericanId, "American", false);
            var hash = AmericanSchedule.CreateR().BuildHashSet();
            Assert.IsTrue(hash.All(kvp => kvp.Value.Count == 8));
        }


        [TestMethod]
        public void AmericanScheduleS()
        {
            AmericanSchedule.CreateS().Verify(14, RecruitingFixup.AmericanId, "American", false);
            var hash = AmericanSchedule.CreateS().BuildHashSet();
            Assert.IsTrue(hash.All(kvp => kvp.Value.Count == 8));
        }


        [TestMethod]
        public void AmericanScheduleT()
        {
            AmericanSchedule.CreateT().Verify(14, RecruitingFixup.AmericanId, "American", false);
            var hash = AmericanSchedule.CreateT().BuildHashSet();
            Assert.IsTrue(hash.All(kvp => kvp.Value.Count == 8));
        }
        ...
        {
            CUSASchedule.CreateA().Verify(4, RecruitingFixup.CUSAId, "CUSA  ", false);
