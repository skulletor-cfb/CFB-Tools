...
namespace EditorTest
{
    ...
    public class UnitTest1
    {
        ...
        {
            AmericanSchedule.CreateA().Verify(15, RecruitingFixup.AmericanId, "American", false);
        ...
        {
            AmericanSchedule.CreateB().Verify(15, RecruitingFixup.AmericanId, "American", false);
