...
namespace EA_DB_Editor
{
    public static class Big12Schedule
    {
        ...
        public static Dictionary<int, int[]> CreateScenarioForSeason()
        {
            ...
            {
                default:
                    var idx = (Form1.DynastyYear - 2556) % Creators.Length;
                    result = Creators[idx]();
                    break;
            }
        ...
        public static Dictionary<int, int[]> CreateA()
        {
            return new List<KeyValuePair<int, int[]>>
            {
                ...
                OkSt.Create(Baylor, TT, Nebraska, Colorado),
                ISU.Create(Baylor, Colorado, KSU, Cincy),
                KSU.Create(Texas, Nebraska, OkSt, KU),
                KU.Create(HOU, OU, ISU, UCF),
                Cincy.Create(HOU, TCU,OkSt,KSU),
                UCF.Create(TT, OU, ISU,Cincy),
            }.Create();
        }
