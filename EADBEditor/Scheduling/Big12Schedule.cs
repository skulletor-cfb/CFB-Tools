...
namespace EA_DB_Editor
{
    public static class Big12Schedule
    {
        ...
        public static Dictionary<int, int[]> CreateA()
        {
            ...
            {
                HOU.Create(Baylor, TT, Nebraska, UCF),
                SMU.Create(HOU, Baylor, KU, OkSt),
                TCU.Create(HOU, SMU, OU, ISU),
                Baylor.Create(TCU, Texas, KU, UCF),
                TT.Create(Baylor, Nebraska, KSU, Cincy),
                Texas.Create(SMU, TT, KSU, OkSt),
                OU.Create(HOU, Baylor, Texas, OkSt),
                Nebraska.Create(TCU, OU, ISU, Cincy),
                ISU.Create(TT, Texas,KSU, Cincy),
                KU.Create(OU, Nebraska, ISU, UCF),
                KSU.Create(HOU, TCU, KU, OkSt),
                OkSt.Create(TT, Nebraska, ISU, UCF),
                Cincy.Create(SMU, TCU, OU, KU),
                UCF.Create(SMU, Texas, KSU, Cincy),
            }.Create();
        }
